...
<br>
<H4> ECO-MATES &nbspONGOING &nbspPROJECTS </H4>
  ...
  <tr>
    ...
    <td>
      <div style="border:3px solid black;width:500px;height:120px;background-color:#00FA9A;border-radius:8px;">
        <form action="ongoingprojs.php" method="POST">
          <br>
...
if (isset($_POST['submit-orgId'])) {

  if (!empty($_POST['organization'])) {
    $thisOrg = $_POST['organization'];  
  }
  else{
...
<br><br><br>
<div>
<form action="ongoingprojs.php" method="POST" style="line-height:140%">
  <?php
  ...
  if($resultCheck1>0){
    while ($row1=mysqli_fetch_assoc($result1)){
      ...
      echo "<b>Current Status".str_repeat('&nbsp;', 3).": </b>".$row1['currentStatus']."<br>";
...
////////////////////////////////////////////Pagination//////////////////////////////////////////
    ...
    for ($i=1; $i <= $totalPages; $i++) { 
      echo '<a href="ongoingprojs.php?page='.$i.'&orgId='.$thisOrg.'" style="color:black">  '.$i.'</a>'.str_repeat('&nbsp;', 4);
    }
    echo "</div>";
////////////////////////////////////////////Pagination//////////////////////////////////////////
  }
  else{
    echo "<b>No published ongoing projects</b><br>";
  }
?>
</form>
</div>
