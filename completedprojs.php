...
<br>
<H4> ECO-MATES &nbspSUCCESSFUL &nbspPROJECTS </H4>
	...
	<tr>
		...
		<td>
			<div style="border:3px solid black;width:500px;height:120px;background-color:#00FA9A;border-radius:8px;">
				<form action="completedprojs.php" method="GET">
					<br>
...
<br><br><br>	
<form action="completedprojs.php" method="POST" style="line-height:140%">
...
<?php
	...
	if($resultCheck1>0){
		while ($row1=mysqli_fetch_assoc($result1)){
			...
			echo "<b>Started Date".str_repeat('&nbsp;', 7).": </b>".$row1['startDate']."<br>";
			echo "<b>Finished Date".str_repeat('&nbsp;', 4).": </b>".$row1['finishDate']."<br>";
			echo "<b>Location".str_repeat('&nbsp;', 13).": </b>".$row1['location']."<br>";
			echo "<b>Total Cost".str_repeat('&nbsp;', 11).": </b> Rs.".$row1['cost']."<br>";
			echo "<b>More Details".str_repeat('&nbsp;', 7).": </b>";?>
			<div style="padding-left: 190px;">
				<?php echo $row1['description'];  ?>
			</div><br>
			<b>Before</b><br>
			<img width="400px" height="300px" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['imageBefore1']); ?>" />	
			<img width="400px" height="300px" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['imageBefore2']); ?>" />
			<br><br><b>Now</b><br>
    	...
    	echo "<b>No published completed projects</b><br>";
  	}	
?>
</form>	
...
echo "<div align='center' style='background:linear-gradient(to right, #339966 0%, #66ff33 100%);line-height:200%;'>Page".str_repeat('&nbsp;', 4);
	...
	for ($i=1; $i <= $totalPages; $i++) { 
		echo '<a href="completedprojs.php?page='.$i.'&orgId='.$thisOrg.'" style="color:black">  '.$i.'</a>'.str_repeat('&nbsp;', 4);
	}
	echo "</div>";
////////////////////////////////////////////Pagination//////////////////////////////////////////
?>
