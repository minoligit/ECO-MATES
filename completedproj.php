...
$sql2 = "SELECT * FROM completedproj WHERE orgId = '$thisOrg' ORDER BY id ASC LIMIT $startFrom,$recordsPerPage;";
...
<form action="completedproj.php" method="POST" style="line-height:140%;">
...
<?php
	...
	if($resultCheck2>0){
		while ($row2=mysqli_fetch_assoc($result2)){
			...
			echo "<b>Started Date".str_repeat('&nbsp;', 7).": </b>".$row2['startDate']."<br>";
			echo "<b>Finished Date".str_repeat('&nbsp;', 4).": </b>".$row2['finishDate']."<br>";
			echo "<b>Location".str_repeat('&nbsp;', 13).": </b>".$row2['location']."<br>";
			echo "<b>Total Cost".str_repeat('&nbsp;', 11).": </b> Rs.".$row2['cost']."<br>";
			echo "<b>More Details".str_repeat('&nbsp;', 7).": </b>";?>
			<div style="padding-left: 190px;">
				<?php echo $row2['description'];  ?>
			</div><br>
			<b>Before</b><br>
			<img width="400px" height="300px" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row2['imageBefore1']); ?>" />	
			<img width="400px" height="300px" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row2['imageBefore2']); ?>" />
			<br><br><b>Now</b><br>
...
echo "<div align='center' style='background:linear-gradient(to right, #339966 0%, #66ff33 100%);line-height:200%;'>Page".str_repeat('&nbsp;', 4);
		...
		$sql3 = "SELECT * FROM completedproj WHERE orgId = '$thisOrg' ORDER BY id ASC;";
