...
<div>
<form action="crudfutureproj.php" method="POST" style="line-height:140%" target="_blank">

<button id="button2" type="submit" name="add-new-proj">Add New Coming Project</button>
<br><br><br>
  ...
  if($resultCheck>0){
    while ($row=mysqli_fetch_assoc($result1)){
      ...
      echo "<b>Date to Start".str_repeat('&nbsp;', 6).": </b>".$row['dateToStart']."<br>";
      ...
      <img width="400px" height="300px" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['imageCurrent3']); ?>" /><br><br> 
