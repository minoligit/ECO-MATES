...
$sql2 = "SELECT * FROM ongoingproj WHERE orgId = '$thisOrg' ORDER BY id ASC LIMIT $startFrom,$recordsPerPage;";
...
<div>
<form action="ongoingproj.php" method="POST" style="line-height:140%">
  <?php
  ...
  if($resultCheck2>0){
    while ($row2=mysqli_fetch_assoc($result2)){
      ...
      echo "<b>Current Status".str_repeat('&nbsp;', 3).": </b>".$row2['currentStatus']."<br>";
...
////////////////////////////////////////////Pagination//////////////////////////////////////////
    ...
    $sql3 = "SELECT * FROM ongoingproj WHERE orgId = '$thisOrg' ORDER BY id ASC;";
