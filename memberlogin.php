...
if (isset($_POST['login'])) {
	...
	if (isset($_POST['username'])) {
		...
		$query1 = "SELECT * FROM members WHERE username='".$uname."' AND password='".$password."'limit 1";
	...
	<div id="login-form">
		...
		<div class="form-popup-login" id="form2">
			<form action="memberlogin.php" method="post">
				...
				<b>Username</b> &nbsp&nbsp&nbsp <input type="text" name="username" placeholder="User Name"><br><br>
